    ...
    <Container>
        <ListCard>
            <Card>
                ...
                <Image src="src/assets/Package.png" alt="pacote"  width={180} hieght={180}/>
            </Card>
            <Card>
                <main>
                ...
                <Image src="src/assets/CurrencyCircleDollar.png" alt="pacote"  width={180} hieght={180}/>
            </Card>
        </ListCard>
        <SectionAbout>
            <Image src="src/assets/Group 2.png" width={160} hieght={160} opacity={0.1}/>
